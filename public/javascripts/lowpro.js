...
/*
An Ajax link that tells the behavior about the element that triggered it.
Access the link element via transport.request.options.behavior.element:

    onLoading : function(transport) {
        link = transport.request.options.behavior.element;
    }
*/
SuperRemoteLink = Behavior.create(Remote.Link, {
    initialize: function($super, options) {
        options = options || {};
        options.behavior = this;
        $super(options);
    }
});
